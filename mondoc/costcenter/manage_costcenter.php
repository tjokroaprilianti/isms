...
<div class="container-fluid">
	<form action="" id="costcenter-form">
...
<script>
	$(document).ready(function(){
		$('#costcenter-form').submit(function(e){
			e.preventDefault();
            var _this = $(this)
			 $('.err-msg').remove();
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_costcenter",
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						uni_modal("<i class='fa fa-th-list'></i> Cost Center Details ","costcenter/view_costcenter.php?id="+resp.cid)
