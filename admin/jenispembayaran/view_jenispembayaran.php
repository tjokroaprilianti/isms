...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    if($qry->num_rows > 0){
		...
		echo '<script>alert("jenispembayaran ID is not valid."); location.replace("./?page=jenispembayaran")</script>';
	}
}else{
	echo '<script>alert("jenispembayaran ID is Required."); location.replace("./?page=jenispembayaran")</script>';
}
?>
<style>
