        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `jenis_pembayaran_list` where delete_flag = 0 order by `name` asc ");
...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='far fa-plus-square'></i> Add New Jenispembayaran ","jenispembayaran/manage_jenispembayaran.php")
		})
