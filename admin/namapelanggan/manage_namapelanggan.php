...
<div class="container-fluid">
	<form action="" id="namapelanggan-form">
...
<script>
	$(document).ready(function(){
		$('#namapelanggan-form').submit(function(e){
			e.preventDefault();
            var _this = $(this)
			 $('.err-msg').remove();
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_namapelanggan",
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						uni_modal("<i class='fa fa-th-list'></i> Namapelanggan Details ","namapelanggan/view_namapelanggan.php?id="+resp.cid)
